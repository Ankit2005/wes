        ...
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <div class="modal-body">
                    <form class="form" method="post" action="api/team">
                        @csrf
                        <p class="description text-center"><b class="font-weight-bold text-uppercase text-dark">Manage your employees group by creating a team such as service team, back and team and many more</b></p>
                        <div class="card-body">
                            {{-- hidden email input --}}
                            <div class="form-group bmd-form-group pb-4 d-none">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input type="hidden" class="form-control" name="team_creator_role" value="{{$_SESSION['team_creator']}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group bmd-form-group pb-4 d-none ">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input type="hidden" class="form-control" name="team_role" value="{{$_SESSION['team_role']}}" placeholder="Enter Team Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group bmd-form-group">
                                ...
                                <textarea class="form-control" name="about_team" id="exampleFormControlTextarea1" placeholder="Describe Somethig About Team." rows="1"></textarea>
                                </div>
                            </div>
                        </div>
